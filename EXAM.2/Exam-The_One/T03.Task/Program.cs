        ...
        static void Main(string[] args)
        {
            ...
            switch (country)
            {
                case "Argentina":
                    ...
                    {
                        totalPrice = souvenirsCount * 3.25;
                    }
                    else if (souvenirsType == "caps")
                    {
                        totalPrice = souvenirsCount * 7.20;
                    }
                    else if (souvenirsType == "posters")
                    {
                        totalPrice = souvenirsCount * 5.10;
                    }
                    else if (souvenirsType == "stickers")
                    {
                        totalPrice = souvenirsCount * 1.25;
                    }
                    else
                    {
                ...
                case "Brazil":
                    if (souvenirsType == "flags")
                    {
                        totalPrice = souvenirsCount * 4.20;
                    }
                    else if (souvenirsType == "caps")
                    {
                        totalPrice = souvenirsCount * 8.50;
                    }
                    else if (souvenirsType == "posters")
                    {
                        totalPrice = souvenirsCount * 5.35;
                    }
                    else if (souvenirsType == "stickers")
                    {
                        totalPrice = souvenirsCount * 1.20;
                    }
                    else
                    {
                        Console.WriteLine("Invalid stock!");
                ...
                case "Croatia":
                    if (souvenirsType == "flags")
                    {
                        totalPrice = souvenirsCount * 2.75;
                    }
                    else if (souvenirsType == "caps")
                    {
                        totalPrice = souvenirsCount * 6.90;
                    }
                    else if (souvenirsType == "posters")
                    {
                        totalPrice = souvenirsCount * 4.95;
                    }
                    else if (souvenirsType == "stickers")
                    {
                        totalPrice = souvenirsCount * 1.10;
                    }
                    else
                    {
                        Console.WriteLine("Invalid stock!");
                ...
                case "Denmark":
                    if (souvenirsType == "flags")
                    {
                        totalPrice = souvenirsCount * 3.10;
                    }
                    else if (souvenirsType == "caps")
                    {
